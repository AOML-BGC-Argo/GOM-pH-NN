%% Gulf of Mexico open ocean Neural Network - Eqn2
% MATLAB version R2023b was used
% Requires MATLAB Deep Learning Toolbox

%% Read data
data = readtable('GOM_Eqn2_training_validation.xlsx','Sheet','Training');
CTDPRS = data.CTDPRS;
CTDTMP = data.CTDTMP;
CTDSAL = data.CTDSAL;
OXYGEN = data.OXYGEN;
...
hiddenLayerSize = [6 6];  %two hidden layers with 6 neurons in each layer
